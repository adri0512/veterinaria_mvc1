...
class usuarioControlador extends usuarioModelo
{
    ...
    {
        $dni = mainModelo::limpiar_cadenas($_POST['usuario_dni_reg']);
        $nombre = mainModelo::limpiar_cadenas($_POST['usuario_nombre_reg']);
        $apellido = mainModelo::limpiar_cadenas($_POST['usuario_apellido_reg']);
        $telefono = mainModelo::limpiar_cadenas($_POST['usuario_telefono_reg']);
        $direccion = mainModelo::limpiar_cadenas($_POST['usuario_direccion_reg']);

        $usuario = mainModelo::limpiar_cadenas($_POST['usuario_usuario_reg']);
        $email = mainModelo::limpiar_cadenas($_POST['usuario_email_reg']);
        $clave1 = mainModelo::limpiar_cadenas($_POST['usuario_clave_1_reg']);
        $clave2 = mainModelo::limpiar_cadenas($_POST['usuario_clave_2_reg']);
        $privilegio = mainModelo::limpiar_cadenas($_POST['usuario_privilegio_reg']);
